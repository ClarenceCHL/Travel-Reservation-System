...
<body>
	...
	try {
		...
		out.print("Test of id: " + repAircraftID);
		...
		if(match == 1){
			out.print("Deleting aircraft from database...");
			out.print("<br>");
			
			String delete = "DELETE FROM aircraft WHERE aircraftID = '" + repAircraftID + "'";
			//String delete = "DELETE FROM airport A" + "WHERE A.airportID='?'";
			PreparedStatement ps = con.prepareStatement(delete);
			//ps.setString(1, repAirportID);
			ps.executeUpdate();
			
			out.print("aircraft removed from database...");
			out.print("<br>");
		} else{
			out.print("<br>");
			out.print("No deletion. No such aircraft exists.");
			out.print("<br>");
		...
		con.close();
		out.print("<br>");
		out.print("aircraft delete page succeeded");
		out.print("<br>");
		
		
	} catch (Exception ex) {
		out.print(ex);
		out.print("aircraft delete page failed");
	}
%>
