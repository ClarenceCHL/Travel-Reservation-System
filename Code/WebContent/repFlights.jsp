...
<body>
	...
	try {
		...
		//ADD
			...
			out.print("<br>");
			out.print("<form method=\"post\" action=\"repFlightsAdd.jsp\">");
				out.print("<table>");
					out.print("<tr>");
						out.print("<b>Add a flight</b>");
					out.print("</tr>");
					out.print("<tr>");
						...
						out.print("</td>");
						out.print("<td>");
							out.print("<input type=\"text\" name=\"type\">");
						out.print("</td>");
						...
						out.print("</td>");
						out.print("<td>");
							out.print("<input type=\"text\" name=\"departTime\">");
						out.print("</td>");					
						...
						out.print("</td>");
						out.print("<td>");
							out.print("<input type=\"text\" name=\"arriveTime\">");
						out.print("</td>");
						...
						out.print("</td>");
						out.print("<td>");
							out.print("<input type=\"text\" name=\"economyFare\">");
						out.print("</td>");
						...
						out.print("</td>");
						out.print("<td>");
							out.print("<input type=\"text\" name=\"businessFare\">");
						out.print("</td>");
						...
						out.print("</td>");
						out.print("<td>");
							out.print("<input type=\"text\" name=\"firstFare\">");
						out.print("</td>");
						...
						out.print("</td>");
						out.print("<td>");
							out.print("<input type=\"text\" name=\"date\">");
						out.print("</td>");
					...
					out.print("<tr>");
						...
						out.print("</td>");
						out.print("<td>");
							out.print("S <input type=\"checkbox\" name=\"day\" value=\"1\">");
						out.print("</td>");
						out.print("<td>");
							out.print("M <input type=\"checkbox\" name=\"day\" value=\"2\">");
						out.print("</td>");
						out.print("<td>");
							out.print("T <input type=\"checkbox\" name=\"day\" value=\"3\">");
						out.print("</td>");
						out.print("<td>");
							out.print("W <input type=\"checkbox\" name=\"day\" value=\"4\">");
						out.print("</td>");
						out.print("<td>");
							out.print("T <input type=\"checkbox\" name=\"day\" value=\"5\">");
						out.print("</td>");
						out.print("<td>");
							out.print("F <input type=\"checkbox\" name=\"day\" value=\"6\">");
						out.print("</td>");
						out.print("<td>");
							out.print("S <input type=\"checkbox\" name=\"day\" value=\"7\">");
						out.print("</td>");
					out.print("</tr>");
		...
		//DELETE
			...
			out.print("<br>");
			out.print("<form method=\"post\" action=\"repFlightsDelete.jsp\">");
				out.print("<table>");
					out.print("<tr>");
						out.print("Delete a flight");
					out.print("</tr>");
					out.print("<tr>");
						out.print("<td>");
							out.print("airlineID");
		...
		//EDIT
			...
			out.print("<br>");
			out.print("<form method=\"post\" action=\"repFlightsEdit.jsp\">");
				out.print("<table>");
					out.print("<tr>");
						out.print("Edit a flight");
					out.print("</tr>");
					out.print("<tr>");
