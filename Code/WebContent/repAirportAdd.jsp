...
<body>
	...
	try {
		...
		if(match == 1){
			out.print("Airport already exists in database");
			out.print("<br>");
		} else{
			//insert into airport
			//Make an insert statement for the Sells table:
			String insert = "INSERT INTO airport(airportID,name)"
					+ "VALUES (?,?)";
			//Create a Prepared SQL statement allowing you to introduce the parameters of the query
			PreparedStatement ps = con.prepareStatement(insert);
			ps.setString(1, repAirportID);
			ps.setString(2, repAirportName);
			ps.executeUpdate();
			
			out.print("airport added to database!");
			out.print("<br>");
