...
<body>
	...
	try {
		...
		//ADD
			...
			out.print("<br>");
			out.print("<form method=\"post\" action=\"repAirportAdd.jsp\">");
				out.print("<table>");
					out.print("<tr>");
						out.print("Add an airport");
					out.print("</tr>");
					out.print("<tr>");
						out.print("<td>");
							out.print("airportID");
						out.print("</td>");
						out.print("<td>");
							out.print("<input type=\"text\" name=\"airportID\">");
						out.print("</td>");
						out.print("<td>");
							out.print("name");
						out.print("</td>");
						out.print("<td>");
							out.print("<input type=\"text\" name=\"airportName\">");
						out.print("</td>");
					out.print("</tr>");
		...
		//DELETE
			...
			out.print("<br>");
			out.print("<form method=\"post\" action=\"repAirportDelete.jsp\">");
				out.print("<table>");
					out.print("<tr>");
						out.print("Delete an airport");
					out.print("</tr>");
					out.print("<tr>");
						out.print("<td>");
							out.print("airportID");
		...
		//EDIT
			...
			out.print("<br>");
			out.print("<form method=\"post\" action=\"repAirportEdit.jsp\">");
				out.print("<table>");
					out.print("<tr>");
						out.print("Edit an airport");
					out.print("</tr>");
					out.print("<tr>");
						out.print("<td>");
							out.print("airportID");
